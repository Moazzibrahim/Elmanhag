...
import 'package:flutter_application_1/views/screens/homework/hw_complete.dart';

class HomeworkMatch extends StatelessWidget {
  const HomeworkMatch({super.key});
      ...
      children: [
        ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const HomeworkComplete()),
            );
          },
          child: const Text(
            'التالي',
