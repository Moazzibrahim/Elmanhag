...
class HomeGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<String> texts = ['واجبات','مناهج','حصص لايف','مراجعات الشهور','حل امتحانات','مراجعة نهائية'];
    List<String> images = ['assets/images/Frame.png','assets/images/Frame (1).png','assets/images/ICON.png','assets/images/Frame (2).png','assets/images/Layer_1.png','assets/images/Group.png'];
