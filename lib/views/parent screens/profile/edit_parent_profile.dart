...
class EditProfileParentScreen extends StatefulWidget {
  final String? childnme;
  final String? parentname;
  final String? imglink;
  const EditProfileParentScreen(
      {super.key, this.childnme, this.parentname, this.imglink});

  @override
  State<EditProfileParentScreen> createState() => _EditProfileScreenState();
}

class _EditProfileScreenState extends State<EditProfileParentScreen> {
  File? _image;
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              CircleAvatar(
                backgroundImage: NetworkImage(widget.imglink!),
                radius: 20,
              ),
              IconButton(
