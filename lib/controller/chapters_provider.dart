...
import 'package:flutter_application_1/views/screens/homework/hw_sections_screen.dart';
...
Future<void> ppostSubjectData(String subjectId, BuildContext context) async {
  final tokenProvider = Provider.of<TokenModel>(context, listen: false);
  final token = tokenProvider.token;
    ...
    if (response.statusCode == 200) {
      ...
      if (responseData['chapter'] != null &&
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                HomeworkSectionsScreen(chapters: responseData['chapter']),
          ),
        );
      } else {
        log('No chapters found in response.');
